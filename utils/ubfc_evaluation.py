...
if __name__ == '__main__':
    fps = 30
    model_path = '/media/pxierra/4ddb33c4-42d9-4544-b7b4-796994f061ce/xiongzhuang/1-PycharmProjects/torchrppg/saved/models/RPPG_PhysNetUpsample_UBFC_PhysFormerLoss/0109_142313/model_best.pth'
    val_pth_dir = "/media/pxierra/e70ff8ce-d5d4-4f52-aa2b-921ff250e5fc/UBFC_PATH/val"
    # evalution
    print("Start eval ... ")
    # load model
